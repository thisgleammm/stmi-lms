...
class coursesController extends Controller
{
    ...
    public function tampil2(?string $course = "", ?string $type = "attendance")
    {
        ...
        return view('coursefile', ['course' => $course, 'type' => $type, 'selectedCourse' => $selectedCourse],compact('users'));
