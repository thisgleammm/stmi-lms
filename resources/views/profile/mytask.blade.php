<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto py-6 ml-60">
        <h1 class="text-xl font-bold text-gray-800 mb-6">Timeline</h1>
                   <div class="mb-4 ml-8">
                <label for="filter" class="block text-gray-600 font-medium mb-2">Filter</label>
                <select id="filter" class="border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm">
            ...
            <div>
                ...
                <h2 class="text-base font-semibold text-gray-700 mb-4 ml-9">Saturday, 30 November 2024</h2>
                <div class="space-y-4 ml-5">
                    ...
                    <div class="bg-gray-100 rounded-lg p-4 flex justify-between items-center">
                        ...
                        <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium">Attempt quiz now</button>
                    </div>
                    <!-- End Task Card -->
