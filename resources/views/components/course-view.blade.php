<div class="rounded grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-12 gap-y-8 mx-4 sm:mx-8 md:mx-16 lg:mx-32 my-4 mb-24 px-4 sm:px-6 lg:px-10">
    @foreach ($courses as $item)
        <div class="bg-white rounded shadow pb-4 w-full flex flex-col">
            ...
            <!-- Progress Bar -->
            <div class="w-11/12 bg-gray-200 mt-8 rounded-full h-2.5 mx-auto">
